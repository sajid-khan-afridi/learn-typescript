...
=======
// tube = ball;//Error
>>>>>>> 9879699f23a69f38fe551e568426b52739d11466
ball = tube;
...
//Rule: When a fresh object literal is assigned to a variable or passed for a parameter of a
//non-empty target type,

//it is an error for the object literal to specify properties that don't exist in the target type.
//The rationale for the below two errors is that since the fresh types of the object literals are
//never captured in variables, static knowledge of the excess or misspelled
//properties should not be silently lost.
>>>>>>> 9879699f23a69f38fe551e568426b52739d11466
